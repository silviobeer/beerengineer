...
| `chat_message` — role agent, final-facing or reviewer feedback | L1 | Final-facing = last message before a prompt / run end. Reviewer feedback is also operator-relevant because it explains the next revision cycle. |
