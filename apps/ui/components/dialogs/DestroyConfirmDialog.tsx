...
export function DestroyConfirmDialog({
  ...
  return (
    <div role="dialog" aria-modal="true" aria-labelledby="destroy-confirm-title" aria-describedby="destroy-confirm-desc" className="fixed inset-0 z-50 grid place-items-center bg-zinc-950/60 p-4">
      <div className="w-full max-w-md space-y-4 border border-red-800 bg-zinc-950 p-4">
        ...
        <p id="destroy-confirm-desc" className="text-sm text-zinc-300">Type <span className="font-mono text-red-200">{expectedName}</span> to confirm.</p>
