...
Revise when a requirement has no architectural home, component responsibilities overlap, a cross-cutting concern has no owner, decisions are generic rather than actionable, risks/open questions are too vague for planning, or a proposed choice contradicts a stated requirement or constraint.

Pass when requirements map cleanly to components, responsibilities are clear, the system/data-flow story is explicit, and downstream planning has enough cross-cutting decisions to avoid reinventing architecture per story.
