...
import {
  ...
  runWorkspaceCodeRabbitStatusCommand,
  runWorkspaceGetCommand,
  runWorkspaceGitStatusCommand,
  runWorkspaceGithubStatusCommand,
  runWorkspaceListCommand,
  runWorkspaceOpenCommand,
  runWorkspacePreviewCommand,
  runWorkspaceRemoveCommand,
  runWorkspaceSonarAuditCommand,
  runWorkspaceSonarEnableCommand,
  runWorkspaceSonarRepairCommand,
...
const COMMAND_REGISTRY: CommandHandlers = {
  ...
  "workspace-git-status": cmd => runWorkspaceGitStatusCommand(cmd.key, cmd.json),
  "workspace-github-status": cmd => runWorkspaceGithubStatusCommand(cmd.key, cmd.json),
  "workspace-sonar-enable": cmd => runWorkspaceSonarEnableCommand(cmd.key, cmd.json),
  "workspace-sonar-audit": cmd => runWorkspaceSonarAuditCommand(cmd.key, cmd.json),
  "workspace-sonar-repair": cmd => runWorkspaceSonarRepairCommand(cmd.key, cmd.apply, cmd.json),
  "workspace-coderabbit-status": cmd => runWorkspaceCodeRabbitStatusCommand(cmd.key, cmd.json),
  ...
  "item-import-prepared": cmd => runItemImportPrepared(cmd.itemRef, cmd.sourceDir, cmd.workspaceKey, cmd.json),
