...
import type { CheckResult, SetupStatus } from "../types.js"
...
export function remedyForTool(tool: string): CheckResult["remedy"] | undefined {
...
export function probeCommand(command: string, args: string[] = []): Promise<ToolProbe> {
...
export function statusIsOk(status: SetupStatus): boolean {
  return status === "ok"
}
