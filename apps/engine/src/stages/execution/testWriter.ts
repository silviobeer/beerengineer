...
import type { AcceptanceCriterion, StoryTestPlanArtifact, UserStory, WaveDefinition, WithArchitecture } from "../../types.js"
import type { TestWriterState } from "./types.js"

export async function writeStoryTestPlan(
