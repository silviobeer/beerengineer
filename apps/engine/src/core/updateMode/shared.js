...
export function resolveNpmCommandForPlatform(platform = process.platform) {
    return platform === "win32" ? "npm.cmd" : "npm";
}
export function resolveSwitcherScriptExtension(platform = process.platform) {
...
export function currentAppVersion() {
    ...
    const parsed = safeReadJson(ENGINE_PACKAGE_JSON);
...
export function resolveManagedInstallPaths(config) {
