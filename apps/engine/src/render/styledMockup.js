...
function safe(raw, pattern, fallback) {
...
function renderCard(label, placeholder) {
...
function renderUnknownElement(kind, label, placeholder) {
...
function buildDarkCssVars(design) {
...
function buildAntiPatternCss(antiPatterns) {
    const rules = [];
 ...
 */
export function renderStyledMockup(screen, design) {
 ...
 */
export function renderMockupIndex(screens, runId, publicBaseUrl) {
